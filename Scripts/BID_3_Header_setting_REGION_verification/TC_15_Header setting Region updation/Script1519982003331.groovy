...
WebUI.waitForPageLoad(200, FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('header_setting/Page_SmartBar  Retailer Dashboard (1)/span_'))

WebUI.click(findTestObject('header_setting/Page_SmartBar  Retailer Dashboard (1)/span_'))

WebUI.click(findTestObject('header_setting/Page_SmartBar  Retailer Dashboard (1)/a_Update'))

WebUI.click(findTestObject('header_setting/Page_SmartBar  Retailer Dashboard (1)/div_Region Updated succesfully'))
