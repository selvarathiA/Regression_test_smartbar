...
WebUI.doubleClick(findTestObject('alert_admin/Page_SmartBar  Admin Dashboard/uib-tab-heading_My Alert'))

WebUI.verifyElementNotChecked(findTestObject('alert_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('alert_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), FailureHandling.STOP_ON_FAILURE)
