...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/admintabs/Page_SmartBar  Admin Dashboard/a_My Alert'))

WebUI.verifyElementChecked(findTestObject('alert_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.uncheck(findTestObject('alert_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), FailureHandling.STOP_ON_FAILURE)
