...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/admintabs/Page_SmartBar  Admin Dashboard/a_Tap Distribution'))

WebUI.verifyElementChecked(findTestObject('BID_8_Permission_verification/product_req/input_ng-pristine ng-untouched'), 0, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.uncheck(findTestObject('BID_8_Permission_verification/product_req/input_ng-pristine ng-untouched'), FailureHandling.STOP_ON_FAILURE)
