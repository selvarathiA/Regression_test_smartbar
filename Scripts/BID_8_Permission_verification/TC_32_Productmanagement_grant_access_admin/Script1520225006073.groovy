...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/product_mngt/Page_SmartBar  Admin Dashboard/a_Product Management'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (5)/input_ng-pristine ng-untouched'), 
    0)

WebUI.check(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (5)/input_ng-pristine ng-untouched'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard/a_Update'), 10)
