...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/categoryandstyle/Page_SmartBar  Admin Dashboard/a_Category  Style'))

WebUI.verifyElementChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (8)/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.uncheck(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (8)/input_ng-pristine ng-untouched'), 
