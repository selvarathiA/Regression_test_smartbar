...
WebUI.verifyElementNotPresent(findTestObject('BID_8_Permission_verification/beerboard_tab/Page_SmartBar  Retailer Dashboard/i_fa fa-television font-size-2'), 
    10)
