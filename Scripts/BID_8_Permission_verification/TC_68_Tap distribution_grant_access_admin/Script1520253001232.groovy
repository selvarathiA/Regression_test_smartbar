...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/Tapdistribution/Page_SmartBar  Admin Dashboard/a_Tap Distribution'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Tapdistribution/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
    10, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('BID_8_Permission_verification/Tapdistribution/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
