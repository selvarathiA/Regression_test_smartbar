...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/share/Page_SmartBar  Admin Dashboard/a_Brand Share'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (10)/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (10)/input_ng-pristine ng-untouched'), 
