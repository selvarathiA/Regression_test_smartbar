...
WebUI.verifyElementChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (6)/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.uncheck(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (6)/input_ng-pristine ng-untouched'), 
