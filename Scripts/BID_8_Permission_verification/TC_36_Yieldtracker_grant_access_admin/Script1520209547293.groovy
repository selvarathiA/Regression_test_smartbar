...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/yieldtracker/Page_SmartBar  Admin Dashboard/a_Yield Tracker'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (6)/input_ng-pristine ng-untouched'), 
    0)

WebUI.check(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (6)/input_ng-pristine ng-untouched'), 
