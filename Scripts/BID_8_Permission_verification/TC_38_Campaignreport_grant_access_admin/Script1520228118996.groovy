...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/camp_report/Page_SmartBar  Admin Dashboard/a_Campaign Report'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (7)/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (7)/input_ng-pristine ng-untouched'), 
