...
WebUI.doubleClick(findTestObject('BID_8_Permission_verification/admintabs/Page_SmartBar  Admin Dashboard/a_Admin Tab'))

WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/admintab_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('BID_8_Permission_verification/admintab_admin/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
