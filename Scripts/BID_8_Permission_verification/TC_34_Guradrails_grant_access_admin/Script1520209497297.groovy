...
WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard/input_ng-pristine ng-untouched'), 
    0)

WebUI.check(findTestObject('BID_8_Permission_verification/Page_SmartBar  Admin Dashboard (1)/input_ng-pristine ng-untouched'), 
