...
WebUI.verifyElementNotChecked(findTestObject('BID_8_Permission_verification/product_req/input_ng-pristine ng-untouched'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('BID_8_Permission_verification/product_req/input_ng-pristine ng-untouched'), FailureHandling.STOP_ON_FAILURE)
