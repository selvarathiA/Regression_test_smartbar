...
WebUI.click(findTestObject('User_creation_deletion/Page_SmartBar  Retailer Dashboard (5)/a_Change Password'))

WebUI.setText(findTestObject('User_creation_deletion/Page_SmartBar  Retailer Dashboard (5)/input_current_password'), 'password')

WebUI.setText(findTestObject('User_creation_deletion/Page_SmartBar  Retailer Dashboard (5)/input_password'), 'password')

WebUI.setText(findTestObject('User_creation_deletion/Page_SmartBar  Retailer Dashboard (5)/input_password_confirmation'), 
    'password123')

WebUI.click(findTestObject('User_creation_deletion/Page_SmartBar  Retailer Dashboard (5)/button_Change Password'))
