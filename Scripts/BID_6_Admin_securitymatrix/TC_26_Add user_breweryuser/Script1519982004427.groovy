...
WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_username'), 'breweryuser')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_password'), 'password')

WebUI.click(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/div_Password Confirmation'))

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_password_confirmation'), 
    'password')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_email'), 'testdolly3@gmail.com')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_first_name'), 'test')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_last_name'), 'dolly3')

WebUI.selectOptionByValue(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/select_ATTVerizonT-MobileSprin'), 
    'string:tmobile', true)

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_mobile'), '987698685')
...
WebUI.click(findTestObject('security matrix/Page_SmartBar  Admin Dashboard (3)/label_Brewery User'))
