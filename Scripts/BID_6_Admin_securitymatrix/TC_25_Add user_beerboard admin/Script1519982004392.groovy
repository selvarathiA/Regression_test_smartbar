...
WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_username'), 'beerboardadmin')
...
WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_email'), 'testdolly1@gmail.com')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_first_name'), 'test')

WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_last_name'), 'dolly1')
...
WebUI.setText(findTestObject('createuser_in groupmanagement/Page_SmartBar  Admin Dashboard/input_mobile'), '78457567')
...
WebUI.click(findTestObject('security matrix/Page_SmartBar  Admin Dashboard (3)/label_Beerboard Admin'))
