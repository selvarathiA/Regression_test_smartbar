...
WebUI.setText(findTestObject('pricemarket_creation_updation_deletion/Page_SmartBar  Admin Dashboard/input_name'), pricemarket)

WebUI.click(findTestObject('pricemarket_creation_updation_deletion/Page_SmartBar  Admin Dashboard/a_Update'))

WebUI.click(findTestObject('pricemarket_creation_updation_deletion/Page_SmartBar  Admin Dashboard/div_Price Market Updated succe'))
